...
export function DistanceChart({ data, theme }: Props) {
  ...
  if (data.length < 2) return <FadeInView><View style={[s.empty, { backgroundColor: c.card }]}><Text style={[s.emptyText, { color: c.textMuted }]}>Add at least 2 refills to see distance</Text></View></FadeInView>;
