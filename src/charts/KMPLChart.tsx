...
export function KMPLChart({ data, theme }: Props) {
  ...
  if (data.length < 2) return <View style={[s.empty, { backgroundColor: c.card }]}><Text style={[s.emptyText, { color: c.textMuted }]}>Add at least 2 refills to see KMPL trend</Text></View>;
